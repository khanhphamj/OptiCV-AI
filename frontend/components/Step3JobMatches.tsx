        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {matches.map(match => {
            ...
            return (
              <li
                key={match.url}
                className="bg-white/70 backdrop-blur border border-slate-200/70 rounded-xl p-3 flex flex-col hover:shadow-md hover:border-emerald-300 transition"
              >
                <div className="flex items-start justify-between gap-2">
                  ...
                  <div className={`flex flex-col items-end shrink-0 ${style.text}`}>
                    <span className="text-xl font-bold leading-none">{match.match_score}%</span>
                ...
                <div className="mt-3 pt-2 border-t border-slate-100 flex items-center justify-between gap-2">
                  ...
                  <button
                    ...
                    className={`inline-flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-semibold text-white shadow transition ${
                      isLowMatch
