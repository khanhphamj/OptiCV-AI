  ...
  return (
    <div className="max-w-2xl mx-auto bg-white p-6 sm:p-8 rounded-3xl shadow-lg border border-slate-200/30">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-gray-900 font-headline">Step 1: Upload Your CV</h2>
        <p className="mt-2 text-gray-600">Upload your resume file. Use your most recent CV for the best results.</p>
      </div>
