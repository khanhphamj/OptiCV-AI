  ...
  return (
    <div className="max-w-2xl mx-auto bg-white p-4 sm:p-6 rounded-3xl shadow-lg border border-slate-200/30">
      <div className="text-center">
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900 font-headline">Step 1: Upload Your CV</h2>
        <p className="mt-1.5 text-sm sm:text-base text-gray-600">Upload your resume file. Use your most recent CV for the best results.</p>
      </div>
