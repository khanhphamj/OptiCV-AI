...
const Header: React.FC = () => {
  return (
    <header className="relative bg-gradient-to-br from-emerald-400 to-teal-500 text-white overflow-hidden shadow-lg">
      <div className="relative z-10 max-w-4xl mx-auto px-3 sm:px-6 lg:px-8 text-center pt-12 sm:pt-16 lg:pt-20 pb-16 sm:pb-20 lg:pb-24">
        ...
        <div className="relative inline-flex items-center gap-4 animate__animated animate__fadeInDown">
          ...
          <h1 className="font-headline text-[1.75rem] sm:text-4xl lg:text-5xl font-bold tracking-tight text-shadow">
            AI-Powered CV Optimizer
          </h1>
        </div>

        <p className="mt-3 sm:mt-4 text-sm sm:text-lg text-white/95 max-w-2xl mx-auto animate__animated animate__fadeInDown" style={{ animationDelay: '200ms' }}>
      ...
      {/* Curved SVG divider */}
      <div className="absolute bottom-0 left-0 w-full h-[64px] sm:h-[80px] lg:h-[100px]" style={{ zIndex: 10 }}>
